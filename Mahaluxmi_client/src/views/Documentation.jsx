...
const DocumentationView = () => {
  const { Product, productData, deleteProduct, Bills,deleteBill,verification} = useAdmin();
  ...
  // Update product state when productData is fetched
  useEffect(() => {
    if (productData) {
      setPr(productData);
    }
  ...
  // Update bills state when billData is fetched
  useEffect(() => {
    if (billdata) {
      setBills(billdata);
    }
